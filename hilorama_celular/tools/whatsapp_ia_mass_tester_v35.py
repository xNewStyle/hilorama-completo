#!/usr/bin/env python3
"""
Tester masivo V35 para el agente WhatsApp IA de Hilorama.

Uso recomendado:
  python tools/whatsapp_ia_mass_tester_v35.py --base-url https://hilorama-celular.onrender.com --pin TU_PIN --limit 100
  python tools/whatsapp_ia_mass_tester_v35.py --base-url https://hilorama-celular.onrender.com --pin TU_PIN --limit 1000 --sleep 0.2

Para 10,000 pruebas:
  python tools/whatsapp_ia_mass_tester_v35.py --base-url https://hilorama-celular.onrender.com --pin TU_PIN --limit 10000 --sleep 0.1

IMPORTANTE: requiere V35/V34/V33/V31/V30 en el servidor porque usa tester_mode/dry_run para NO guardar conversaciones reales.
"""
...
def write_reports(results: List[Dict[str, Any]], out_dir: Path):
    ...
    <h1>Reporte tester WhatsApp IA Hilorama V35</h1>
