#!/usr/bin/env python3
"""
Tester masivo V32 para el agente WhatsApp IA de Hilorama.

Uso recomendado:
  python tools/whatsapp_ia_mass_tester_v32.py --base-url https://hilorama-celular.onrender.com --pin TU_PIN --limit 100
  python tools/whatsapp_ia_mass_tester_v32.py --base-url https://hilorama-celular.onrender.com --pin TU_PIN --limit 1000 --sleep 0.2

Para 10,000 pruebas:
  python tools/whatsapp_ia_mass_tester_v32.py --base-url https://hilorama-celular.onrender.com --pin TU_PIN --limit 10000 --sleep 0.1

IMPORTANTE: requiere V32/V31/V30 en el servidor porque usa tester_mode/dry_run para NO guardar conversaciones reales.
"""
